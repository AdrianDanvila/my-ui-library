  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between ">
      ...
      <Card
        ...
        auctor magna tortor, ut molestie ante sollicitudin eget. Morbi vitae
        pellentesque erat. Morbi gravida vel mauris id mattis. Nunc eget
        tristique enim. Duis dictum tincidunt mi vitae ornare. Sed vitae tellus
        interdum, fermentum diam vitae, placerat mi
      </Card>
